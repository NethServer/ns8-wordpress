...
container=$(buildah from docker.io/wordpress:7.0.0-php8.3-apache)
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/mariadb:10.11.17 ${repobase}/wordpress-app:${IMAGETAG:-latest}" \
    "${container}"
# Commit the image
