...
container=$(buildah from docker.io/wordpress:6.9.4-php8.3-apache)
...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/mariadb:10.11.16 ${repobase}/wordpress-app:${IMAGETAG:-latest}" \
    "${container}"
# Commit the image
